...
def load_data(data_file, field_idx0, field_idx1):
    ...
    with open(data_file, 'r') as f:
		...
		#data[1].append(float(fields[3].strip()))
		data[1].append(float(fields[6].strip()))
                #data[1].append( ( float(fields[field_idx1].strip()) + float(fields[3].strip()) + float(fields[4].strip()) + float(fields[5].strip()) + float(fields[6].strip()) )/5 )
    return data
