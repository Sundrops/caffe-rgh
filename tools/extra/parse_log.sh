...
grep 'Test net output #4' aux.txt | awk '{print $11}' > aux7.txt
...
# Generating
echo '#Iters Seconds TestAccuracy TestAccuracy TestAccuracy TestAccuracy TestAccuracy '> $LOG.test
paste aux0.txt aux4.txt aux1.txt aux2.txt aux5.txt aux6.txt aux7.txt | column -t >> $LOG.test
