...
template <typename Dtype>
void WriteBlobToMat(const char *fname, bool write_data, bool write_diff,
    Blob<Dtype>* blob) {
  mat_t *matfp;
...
template void WriteBlobToMat<float>(const char*, bool,bool, Blob<float>*);
template void WriteBlobToMat<double>(const char*, bool,bool, Blob<double>*);
template void WriteBlobToMat<int>(const char*, bool,bool, Blob<int>*);
template void WriteBlobToMat<unsigned int>(const char*, bool,bool, Blob<unsigned int>*);
